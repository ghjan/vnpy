...
vtSymbol直接使用symbol
'''
from vnpy.trader.language.chinese.constant import EXCHANGE_CFFEX, PRICETYPE_LIMITPRICE, PRICETYPE_MARKETPRICE, \
    DIRECTION_LONG, DIRECTION_SHORT, OFFSET_OPEN, OFFSET_CLOSE, OFFSET_CLOSETODAY, OFFSET_CLOSEYESTERDAY, EXCHANGE_SHFE, \
    EXCHANGE_CZCE, EXCHANGE_DCE, EXCHANGE_SSE, EXCHANGE_SZSE, EXCHANGE_INE, EXCHANGE_UNKNOWN, DIRECTION_NET, \
    DIRECTION_UNKNOWN, OFFSET_UNKNOWN, STATUS_REJECTED, PRODUCT_FUTURES, PRODUCT_OPTION, PRODUCT_COMBINATION, \
    PRODUCT_EQUITY, PRODUCT_UNKNOWN, OPTION_CALL, OPTION_PUT, STATUS_ALLTRADED, STATUS_PARTTRADED, STATUS_NOTTRADED, \
    STATUS_CANCELLED, STATUS_UNKNOWN, PRICETYPE_FAK, PRICETYPE_FOK
